           ...
           if(!$db)
               {
                  echo "Error : Unable to open database\n";
                     ...
                     $query = "SELECT kh.* , ngayden FROM khachhang as kh natural join thuephong as tp
                      WHERE (lower(makh) LIKE '%$timkiem%' OR lower(hotenkh) LIKE '%$timkiem%' OR lower(dc) LIKE '%$timkiem%' OR lower(quoctich) LIKE '%$timkiem%' OR lower(cmnd) LIKE '%$timkiem%' OR lower(tel) LIKE '%$timkiem%' OR lower(ngayden) LIKE '%$timkiem%' )AND (thanhtoan !='Đã TT') " ;
