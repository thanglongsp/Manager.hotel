...
<ul>
    ...
    <?php
       ...
       $db = pg_connect( "$host $port $dbname $credentials"  );
        ...
        $sql = "SELECT map, tenp, loaip, (gia||'đ') as gia, trangthai  FROM phong where trangthai = 'Kín' order by map asc ";
        ...
        $sqlx = "SELECT map, tenp, loaip, (gia||'đ') as gia, trangthai  FROM phong where trangthai = 'Trống' order by map asc ";
    ...
    <div id = "left">
      ...
      <div id="right">
             <center><h2>Phòng trống</h2></center>
              <div style="overflow-x:auto;">
              <center>
                  <table  width="600" border="2">
                      <tr>
