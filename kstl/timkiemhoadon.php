          ...
          <?php           
                  ...
                  if(isset($_REQUEST["ok"]))
                  {
                    ...
                    $sql = "SELECT kh.*, tp.ngayden,tp.ngaydi,tp.thanhtoan, p.map,p.tenp,p.loaip,p.gia
                             ...
                             WHERE (lower(kh.makh) LIKE '%$timkiem%' OR lower(hotenkh) LIKE '%$timkiem%' OR lower(dc) LIKE '%$timkiem%' OR lower(quoctich) LIKE '%$timkiem%') OR lower(cmnd) LIKE '%$timkiem%' OR lower(tel) LIKE '%$timkiem%'
                              OR lower(ngayden) LIKE '%$timkiem%' OR lower(ngaydi) LIKE '%$timkiem%'
